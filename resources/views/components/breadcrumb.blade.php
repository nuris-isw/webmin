        ...
        @foreach ($filteredItems as $label => $url)
            <li>
                <div class="flex items-center">
                    ...
                    @if ($loop->last)
                        <span class="text-gray-800 dark:text-gray-200 truncate max-w-37.5 md:max-w-none">
                            {{ $label }}
                        </span>
                    @else
                        <a href="{{ $url }}" class="hover:text-brand-red transition truncate max-w-37.5 md:max-w-none">
                            {{ $label }}
                        </a>
                    @endif
                </div>
