    ...
    <nav class="px-4 py-6 space-y-7">
        ...
        @if (Auth::user()->isSuperadmin() || Auth::user()->unit_id !== null)
            <div class="space-y-2">
                ...
                <div class="mt-2 space-y-1">
                    <x-nav-link :href="Route::has('admin.profile.edit') ? route('admin.profile.edit') : '#'" :active="request()->routeIs('admin.profile.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        @if (Auth::user()->isSuperadmin() || Auth::user()->unit_id !== null)
            <div class="space-y-2">
                ...
                <div class="mt-2 space-y-1">
                    <x-nav-link :href="Route::has('admin.achievements.index') ? route('admin.achievements.index') : '#'" :active="request()->routeIs('admin.achievements.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <x-nav-link :href="Route::has('admin.extracurriculars.index') ? route('admin.extracurriculars.index') : '#'" :active="request()->routeIs('admin.extracurriculars.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        @if (Auth::user()->isSuperadmin() || Auth::user()->unit_id !== null)
            <div class="space-y-2">
                ...
                <div class="mt-2 space-y-1">
                    <x-nav-link :href="Route::has('admin.news.index') ? route('admin.news.index') : '#'" :active="request()->routeIs('admin.news.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <x-nav-link :href="Route::has('admin.galleries.index') ? route('admin.galleries.index') : '#'" :active="request()->routeIs('admin.galleries.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                        </svg>
                        Galeri Kegiatan
                    </x-nav-link>
                    <x-nav-link :href="Route::has('admin.spmb.edit') ? route('admin.spmb.edit') : '#'" :active="request()->routeIs('admin.spmb.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        @if (Auth::user()->isSuperadmin() || (Auth::user()->unit && Auth::user()->unit->isSmk()))
            <div class="space-y-2">
                ...
                <div class="mt-2 space-y-1">
                    <x-nav-link :href="Route::has('admin.majors.index') ? route('admin.majors.index') : '#'" :active="request()->routeIs('admin.majors.*')">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
